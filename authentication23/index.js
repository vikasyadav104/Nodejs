...
// Changed from controller/user to middlewares/auth
const {
...
// You can keep your old connection string if you want
...
// cookieParser should come before routes
app.use(cookieParser());

app.use("/url", restrictToLoggedinUserOnly, urlRoute);
app.use("/user", userRoute);

// checkAuth middleware added here
...
// Changed from "/:shortId" to "/url/:shortId"
...
//now i design that on enter username and password in login page then direcrly url page open
//but as i mention in txt file i design it where first i get cokkies then enter
//so for cookies i visit npm uuid